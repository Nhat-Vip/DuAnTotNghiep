...
function InsertProduct()
{
    ...
    if (!isset($_POST["productName"], $_POST["price"], $_POST["type"], $_POST["status"], $_POST["detail"], $_FILES["image"])) {
        echo json_encode(["status" => "error", "message" => "Thiếu dữ liệu cần để thêm sản phẩm"]);
        exit();
    }
    ...
    $sql = "Insert into product(productName, price, image_path, productStatus, detail, productType)
